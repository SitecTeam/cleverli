...
const TimeSelect = ({
  ...
  return (
    <Select value={value} onValueChange={onChange} data-slot="time-select">
      <SelectTrigger
        className={cn(
          "flex h-auto w-full cursor-pointer rounded-none border-0 border-b border-white bg-transparent px-0 py-2 text-base text-white shadow-none transition-colors select-none focus:ring-0 focus-visible:border-orange-400 focus-visible:ring-0 focus-visible:outline-none data-[placeholder]:text-[#8596AB] data-[size=default]:h-auto md:text-sm [&>svg]:hidden",
          className
        )}
      >
