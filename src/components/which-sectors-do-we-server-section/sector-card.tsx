...
const SectorCard = ({
  ...
  return (
    <Card
      className="relative min-h-92.5 border-none bg-linear-to-t from-[#F8F7F8] via-[#D5DBE2] to-[#B0BBC9] pt-2 pb-2.5 min-[1430px]:h-75 min-[1430px]:min-h-max lg:bg-linear-to-l lg:py-5"
    ...
    >
      ...
      />
      <CardContent className="z-10 flex h-full flex-col gap-4 px-3 lg:flex-row lg:gap-10 lg:pr-0 lg:pl-15">
        <div className="flex h-full flex-1 flex-col gap-4">
          ...
          <p className="font-frutiger text-center text-sm italic lg:text-start lg:text-xl">
            {description}
          </p>
        </div>
        <div className="h-px w-full shrink-0 bg-slate-800 px-3 lg:h-[85%] lg:w-px lg:self-center lg:px-0" />
        <div className="flex flex-1 flex-col justify-center gap-1.5 px-1 lg:justify-evenly lg:gap-2 lg:px-10 lg:py-1">
