export const data = [
  {
    ...
    details: [
      ...
      "Internal capability building & team training",
  ...
  },
  {
    ...
    details: [
      ...
      "Microlearning & mobile-friendly formats",
      "Knowledge checks, quizzes & certifications",
      "SCORM/xAPI packaging for seamless LMS integration",
      "PowerPoint-to-e-learning conversion (Articulate Rise/Storyline)",
    ],
  },
  {
    id: 3,
    ...
    details: [
      ...
      "Promotional videos, teasers & social media content",
      "Video editing & post-production",
      "Voice-over, subtitles & localization",
    ],
  },
  {
    id: 4,
    ...
    details: [
      ...
      "Brand identity development & logo design",
      "Book layouts, publication design & print materials",
      "Workbooks, PDF guides & printable resources",
      "Icons, banners, digital assets & templates",
      "Presentation design & slide deck enhancement",
  ...
  },
  {
    ...
    details: [
      ...
      "Cultural adaptation of visuals & examples",
  ...
  },
  {
    ...
    details: [
      ...
      "Database cleaning & preparation",
      "Data visualization & infographic reports",
      "Assessment & evaluation analysis",
      "Predictive insights & statistical modeling",
      "Tools: SPSS, Excel, Python, R, Tableau",
    ],
  },
  {
    id: 7,
    ...
    details: [
      ...
      "Localization & SCORM packaging",
      "Ongoing updates & content maintenance",
