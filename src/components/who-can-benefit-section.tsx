  ...
  ({ partner, index, isInView, transition, onRefMount }) => {
    ...
    return (
      ...
      >
        ...
        <p className="text-center text-sm font-medium whitespace-pre-line text-ink-secondary">
          {title}
        </p>
      </motion.div>
    );
  ...
  ({ partner, index }) => {
    ...
    return (
      <div className="group flex items-center justify-between gap-4 py-2">
        {/* Text on the left */}
        <p className="text-left text-base leading-tight font-semibold whitespace-pre-line text-ink-secondary">
          {title}
        </p>
  ...
  return (
    <section className="flex w-full flex-col items-center gap-8 lg:gap-12">
      <SectionTitleAnimation
        text="Who Can Benefit From Our Services?"
        className="text-ink-secondary"
      />
      <FadeInWrapper className="space-y-4 text-center">
        <p className="text-xl text-ink-secondary italic lg:text-[32px]">
