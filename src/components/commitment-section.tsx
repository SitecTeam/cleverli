  ...
  return (
    <FadeInWrapper className="relative lg:mt-10 lg:px-12">
      ...
      <div className="relative w-full rounded-lg border border-white/60 bg-white/70 px-4.5 py-2.5 shadow-card backdrop-blur-lg sm:rounded-4xl sm:px-10 sm:py-8 lg:py-12 lg:backdrop-blur-xs xl:px-12.5">
        {/* Desktop header */}
        <h2 className="hidden leading-tight font-bold text-[#3F3E3E] lg:block lg:text-6xl">
          Our Sustainability Commitment
        </h2>
        <div className="grid gap-2 sm:gap-10 lg:mt-26 lg:grid-cols-2 lg:gap-14">
          {/* Left copy */}
          <div className="flex flex-col gap-12">
            <p className="font-medium text-[#3F3E3E] sm:text-xl sm:leading-relaxed lg:max-w-125 lg:text-2xl lg:text-balance">
            ...
            {/* Desktop text */}
            <p className="hidden max-w-125 text-4xl text-[#3F3E3E] italic lg:block">
          ...
          <div className="grid grid-cols-1 gap-1 pl-4 sm:grid-cols-2 sm:gap-5 sm:pl-0 lg:flex lg:flex-col lg:pt-7 lg:pl-20 xl:pl-40">
            <div className="flex gap-4 text-[#3F3E3E] sm:items-end">
              <img
                src={Leaf}
            ...
            <div className="flex gap-4 text-[#3F3E3E] sm:items-end">
              ...
              />
              <div className="flex flex-col gap-1">
                <p className="text-base font-bold sm:text-xl">Reduced Travel</p>
                <p className="text-base font-medium sm:text-xl">
          ...
          {/* Mobile text */}
          <p className="mx-1.5 border-t-2 border-slate-700 pt-3 text-xl text-[#3F3E3E] italic sm:mx-0 sm:text-3xl lg:hidden">
            Digital learning isn't just smarter. It's greener.
          </p>
        </div>
      </div>
