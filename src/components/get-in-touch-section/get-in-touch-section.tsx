...
const GetInTouchSection = () => {
  return (
    <FadeInWrapper className="-mx-4 flex h-full w-screen flex-col items-start bg-linear-to-t from-[#22272F] to-[#394453] text-white lg:mx-0 lg:min-h-196 lg:w-full lg:py-13.5">
      <div className="flex w-full flex-1 flex-col items-stretch gap-10 px-7.5 pt-5 pb-10 lg:flex-row lg:gap-10 lg:px-10 lg:py-0 2xl:gap-25 2xl:px-21">
        <div className="flex-1 space-y-6 lg:space-y-15 2xl:flex-none">
          <h2 className="text-center text-4xl font-bold lg:mt-4 lg:text-start lg:text-6xl">
            Get in Touch
          </h2>
          ...
          <div className="space-y-3.5 pl-3 sm:text-xl lg:space-y-9 lg:px-0">
            ...
            <div className="flex gap-8">
              ...
              <div className="flex flex-col sm:gap-1.5">
                <span className="text-sm text-[#8596AB] sm:text-base lg:-mt-2">
                  Phone
                </span>
