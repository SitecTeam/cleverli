...
const GetInTouchForm = () => {
  ...
  return (
    <div className="flex h-fit w-full flex-col justify-center rounded-2xl bg-transparent from-ink-secondary to-[#394453] pl-3 lg:bg-linear-to-b lg:px-9 lg:pt-8 lg:pb-10 lg:shadow-form 2xl:px-12">
